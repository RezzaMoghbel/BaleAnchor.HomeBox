...
public sealed class BoilerAssumptionManagementItemResponse
{
...
public sealed class BoilerAssumptionManagementResponse
{
    public required string UserId { get; init; }
    public required string OnDate { get; init; }
    public required int Count { get; init; }
    public required IReadOnlyList<BoilerAssumptionManagementItemResponse> Items { get; init; }
}
